@php
   ...
   $menuItems = [
       ...
       [
           'href' => 'view.employee.list',
           'label' => 'Employees',
           'icon' => 'people',
       ],
       [
           'href' => 'view.department.list',
           'label' => 'Departments',
           'icon' => 'diagram-3',
       ],
   ];
      ...
      <ul role="list" class="flex flex-1 flex-col gap-y-7">
         <li>
            <ul role="list" class="-mx-2 space-y-1">
               @foreach ($menuItems as $item)
                  <li>
                     <x-ui.menu-nav-link :href="route($item['href'])" :active="request()->is($item['href'])">
         ...
         <li>
            <a href="#"
               ...
               <svg class="h-6 w-6 shrink-0 text-muted group-hover:text-white" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor"
                  aria-hidden="true">
