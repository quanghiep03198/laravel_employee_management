<div x-data="{ open: false }" class="sticky top-0 !z-[100]">
         ...
         <div class="flex h-16 items-center justify-between xl:justify-end">
            ...
            <div class="flex flex-1 items-center divide-x divide-border xl:divide-x-0">
               <div class="pr-4">
                  ...
                  <button class="aspect-square inline-flex h-8 w-8 items-center justify-center rounded p-2 text-foreground xl:hidden" @click="open = ! open">
               ...
               <div class="relative flex flex-1 items-center gap-x-2 bg-background pl-4 xl:p-0">
                  ...
                  <form action="">
                     <input type="text" class="block border-none text-sm focus:outline-none focus:!ring-0" placeholder="Search ...">
                  </form>
                  ...
                  <x-slot name="trigger">
                     <button
                        ...
                        <img class="h-18 w-8 rounded-full ring-offset-2 group-focus:ring-[2px] group-focus:ring-primary"
                           src="https://ui-avatars.com/api/?name={{ substr(Auth::user()->name, 0, 1) }}" alt="">
   ...
   <div x-show="open" x-transition:enter="transition ease-in-out duration-300" @close.stop="open = false" x-transition:enter-start="-translate-x-full"
   ...
   <div x-show="open" @close.stop="open = false" x-transition:enter="transition ease-in-out duration-300" x-transition:enter-start="opacity-0"
      x-transition:enter-end="opacity-100" x-transition:leave="transition ease-in-out duration-300" x-transition:leave-start="opacity-100"
