<div class="w-72 bg-background-contrast text-foreground-contrast p-6 xl:fixed h-full">
    <!-- Logo -->
        ...
        <ul role="list" class="flex flex-1 flex-col gap-y-7">
            <li>
                <ul role="list" class="-mx-2 space-y-1">
                    <li>
                        <a href="#"
                            class="hover:bg-primary transition-colors duration-300 text-white group flex gap-x-3 rounded-md p-2 text-sm leading-6 font-semibold">
                    ...
                    <li>
                        <a href="#"
                            class="text-muted hover:text-white hover:bg-primary transition-color duration-300 group flex gap-x-3 rounded-md p-2 text-sm leading-6 font-semibold">
                            <svg class="h-6 w-6 shrink-0 text-muted group-hover:text-white" fill="none"
