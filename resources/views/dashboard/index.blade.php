<x-app-layout>
        ...
        <div class="rounded-lg border border-border bg-white p-4 shadow-sm">
            <div class="flex flex-row items-center justify-between space-y-0 pb-2">
                ...
                <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="none" stroke="currentColor"
                    strokeLinecap="round" strokeLinejoin="round" strokeWidth="2" class="text-muted-foreground h-4 w-4">
    ...
    <div class="grid gap-4 md:grid-cols-2 xl:grid-cols-7">
        <div class="col-span-full overflow-x-auto rounded-lg bg-background p-4 scrollbar-thin xl:col-span-4">
            ...
            <div class="mt-6 flex flex-col justify-end text-center text-sm font-medium">Sale chart</div>
        </div>
    ...
    <script>
        ...
        new Chart(ctx, {
            ...
            data: {
                ...
                datasets: [{
                    label: '# of Votes',
                    data: [1020, 1900, 3000, 5000, 2000, 3000, 2200, 1000, 1100, 2900, 1400, 1600],
                    borderWidth: 1,
