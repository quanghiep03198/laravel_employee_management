...
<x-app-layout>
	...
	<form action="{{ route('api.employee.add') }}" method="POST"
		...
		@csrf
		<div class="grid-rows-7 mb-6 grid w-full grid-flow-col gap-6 sm:grid-flow-row sm:grid-cols-1">
			...
			<x-ui.input-field-control name="phone_number" :error="$errors" :label="'Phone number'" placeholder="xxxx xxx xxx" />
