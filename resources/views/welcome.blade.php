...
<body class="antialiased">
   <div class="bg-gray-900" x-data="{ open: false }">
      <header class="absolute inset-x-0 top-0 z-50">
         <nav class="flex items-center justify-between p-6 lg:px-8" aria-label="Global">
            ...
            <div class="flex xl:hidden">
               <button type="button" @click="open = true" class="-m-2.5 inline-flex items-center justify-center rounded-md p-2.5 text-gray-400">
            ...
            <div class="hidden xl:flex xl:gap-x-12">
               <a href="#" class="text-sm font-semibold leading-6 text-foreground-contrast transition-colors duration-300 hover:text-primary">Product</a>
               <a href="#" class="text-sm font-semibold leading-6 text-foreground-contrast transition-colors duration-300 hover:text-primary">Features</a>
               <a href="#"
               ...
               <a href="#" class="text-sm font-semibold leading-6 text-foreground-contrast transition-colors duration-300 hover:text-primary">Company</a>
            </div>
            @if (Route::has('login'))
         ...
         <div role="dialog" aria-modal="true" @close.stop="open = false">
            ...
            <div class="fixed inset-0 z-50 bg-gray-950/80" @click="open = false" x-show="open" x-transition:enter="transition ease-in-out duration-300"
               x-transition:enter-start="opacity-0" x-transition:enter-end="opacity-100" x-transition:leave="transition ease-in-out duration-300"
               x-transition:leave-start="opacity-100" x-transition:leave-end="opacity-0"></div>
            <div x-show="open" x-transition:enter="transition ease-in-out duration-300" x-transition:enter-start="translate-x-full"
               x-transition:enter-end="translate-x-0" x-transition:leave="transition ease-in-out duration-300" x-transition:leave-start="translate-x-0"
               ...
               <div class="mt-6 flow-root">
                  <div class="-my-6 divide-y divide-gray-500/25">
                     ...
                     <div class="py-6">
                        <a href="#" class="-mx-3 block rounded-lg px-3 py-2.5 text-base font-semibold leading-7 text-white hover:bg-gray-800">Log
                           in</a>
                     </div>
                  </div>
               </div>
      ...
      <div class="relative isolate h-screen overflow-hidden pt-14">
         ...
         <div class="absolute left-1/2 top-1/2 mx-auto w-full max-w-2xl -translate-x-1/2 -translate-y-1/2 sm:max-w-full">
            <div class="mb-8 flex justify-center sm:hidden">
               <div class="relative rounded-full px-3 py-1 text-sm leading-6 text-gray-400 ring-1 ring-white/10 hover:ring-white/20">
                  Announcing our next round of funding. <a href="#" class="font-semibold text-white"><span class="absolute inset-0"
