...
<body class="antialiased">
    <div class="bg-gray-900" x-data="{ open: false }">
        <header class="absolute inset-x-0 top-0 z-50">
            <nav class="flex items-center justify-between p-6 lg:px-8" aria-label="Global">
                ...
                <div class="hidden xl:flex xl:gap-x-12">
                    <a href="#"
                        class="font-semibold text-foreground-contrast text-sm leading-6 hover:text-primary transition-colors duration-300">Product</a>
                    <a href="#"
                        class="font-semibold text-foreground-contrast text-sm leading-6 hover:text-primary transition-colors duration-300">Features</a>
                    <a href="#"
                        class="font-semibold text-foreground-contrast text-sm leading-6 hover:text-primary transition-colors duration-300">Marketplace</a>
                    <a href="#"
                        class="font-semibold text-foreground-contrast text-sm leading-6 hover:text-primary transition-colors duration-300">Company</a>
                </div>
                @if (Route::has('login'))
                    <div class="xl:flex items-center justify-end gap-x-6 hidden">
                        @auth
                            <a href="{{ url('/dashboard') }}"
                                class="font-semibold text-foreground-contrast text-sm leading-6 hover:text-primary transition-colors duration-300">
                        ...
                        @else
                            <a href="{{ route('login') }}"
                                class="font-semibold text-foreground-contrast text-sm leading-6 hover:text-primary transition-colors duration-300">Log
                                in</a>

                            @if (Route::has('register'))
                                <a href="{{ route('register') }}"
                                    class="font-semibold text-foreground-contrast text-sm leading-6 hover:text-primary transition-colors duration-300">Register</a>
                            @endif
                        @endauth
                    </div>
                @endif
        ...
        <div class="relative isolate overflow-hidden pt-14 h-screen">
            ...
            <div
                class="mx-auto max-w-2xl sm:max-w-full w-full -translate-y-1/2 top-1/2 absolute -translate-x-1/2 left-1/2">
                <div class="sm:hidden mb-8 flex justify-center">
                    <div
                ...
                <div class="text-center">
                    <h1 class="text-4xl font-bold tracking-tight text-white xl:text-6xl">Data to enrich your online
                        business</h1>
                    ...
                    <div class="mt-10 flex items-center justify-center gap-x-6">
                        <a href="#"
                            class="rounded-md bg-primary px-3.5 py-2.5 text-sm font-semibold text-white shadow-sm hover:opacity-80 transition-opacity duration-300 focus-visible:outline focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-indigo-400">Get
                            started</a>
